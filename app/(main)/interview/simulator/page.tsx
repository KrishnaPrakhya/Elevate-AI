...
export default function InterviewSimulator() {
  ...
  const transcribeAudio = async (audioBlob: Blob) => {
    try {
      ...
      const response = await axios.post("/api/interview-simulator/transcribe", formData);
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary">
            ...
            <span className="text-sm font-medium">AI-Powered Mock Interviews</span>
          </div>
          <h1 className="text-4xl font-bold">Interview Simulator</h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Practice with realistic AI-generated interview questions tailored to your role and experience level.
                ...
                >
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      Speak your answers with real-time transcription
                    </span>
                  </div>
                </button>
                <button
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-900 dark:text-blue-100">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-blue-800 dark:text-blue-200">
                    <li>AI-generated questions based on your role and level</li>
                    <li>Adaptive difficulty based on your answers</li>
                    <li>Real-time transcription (voice mode)</li>
                    <li>Detailed feedback with scores and improvement tips</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-2 flex-1">
              <div className="flex items-center gap-2">
                ...
                <Badge variant={currentQuestion?.difficulty === "hard" ? "destructive" : currentQuestion?.difficulty === "medium" ? "secondary" : "outline"}>
